...
<body id="top"
  class="{block 'body_class'}{/block} {($_modx->config['site_dev_mode'] ? 'mode_development' : 'mode_production')}">
  <div class="fill fill_image-green">
    {include 'path:_/sections/header.tpl'}
  </div>
    ...
    <div class="fill fill_image fill_image-green_with-image section-padding pb-0">
      <div class="container">
        <div class="row">
          <div class="col-12">
            {include 'path:_/components/intro/index.tpl'}
          </div>
        </div>
      </div>
    </div>
    <div class="container section-padding">
      <div class="row">
        <div class="col-12">
          {include 'path:_/components/about/index.tpl'}
        </div>
      </div>
    </div>
    <div class="fill fill_gray-light section-padding">
      <div class="container section-padding">
        <div class="row">
          <div class="col-12">
            {include 'path:_/components/docs/index.tpl'}
          </div>
        </div>
      </div>
    </div>
    <div class="container section-padding">
      <div class="row">
        <div class="col-12">
          {include 'path:_/components/requisites/index.tpl'}
        </div>
      </div>
    </div>
    <div class="fill fill_gray-light section-padding">
      <div class="container section-padding">
        <div class="row">
          <div class="col-12">
            {include 'path:_/components/building/index.tpl'}
          </div>
        </div>
      </div>
    </div>
    <div class="container section-padding">
      <div class="row">
        <div class="col-12">
          {include 'path:_/components/feedback/index.tpl'}
        </div>
      </div>
    </div>
    <div class="container section-padding">
      <div class="row">
        <div class="col-12">
          {include 'path:_/components/contacts/index.tpl'}
        </div>
      </div>
    </div>
  {block 'before_footer'}{/block}
    {include 'path:_/sections/footer.tpl'}
